                ...
                <div class="p-6 text-slate-900">
                    ...
                    <form action="{{ route('roles.update', $role) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="name" id="name" class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 sm:text-sm" value="{{ old('name', $role->name) }}" required>
                        </div>
