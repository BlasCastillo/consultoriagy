        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('gobernadores.update', $gobernador->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nombres" id="nombres" value="{{ $gobernador->nombres }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-900 focus:ring-blue-900 sm:text-sm" required>
                        </div>
                        <div class="mb-4">
                            <label for="apellidos" class="block text-sm font-medium text-gray-700">Apellidos</label>
                            <input type="text" name="apellidos" id="apellidos" value="{{ $gobernador->apellidos }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-900 focus:ring-blue-900 sm:text-sm" required>
                        </div>
                        <div class="mb-4 flex items-center">
                            <input type="checkbox" name="estado" id="estado" value="1" {{ $gobernador->estado ? 'checked' : '' }} class="h-4 w-4 text-blue-900 border-gray-300 rounded focus:ring-blue-900">
