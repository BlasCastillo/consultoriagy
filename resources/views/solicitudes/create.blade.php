        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-bold mb-4 text-slate-800 border-b pb-2">Datos del Sumario a Publicar</h3>
                    ...
                    <div class="bg-gray-50 p-4 rounded-md mb-6 border border-gray-200">
                        ...
                        <p class="text-lg text-slate-800">{{ $institution->name }}</p>
                    </div>
                            ...
                            <div class="sumario-item border border-gray-200 p-4 rounded-md bg-white shadow-sm relative">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select name="sumarios[0][tipo_acto]" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-slate-800 focus:ring-slate-800 sm:text-sm">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="sumarios[0][numero_acto]" required placeholder="Ej: 001-2026" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-slate-800 focus:ring-slate-800 sm:text-sm">
                                    </div>
                                    <div class="md:col-span-2">
                                        <label class="block text-sm font-medium text-gray-700">Descripción Corta / Asunto <span class="text-red-500">*</span></label>
                                        <textarea name="sumarios[0][descripcion]" required rows="2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-slate-800 focus:ring-slate-800 sm:text-sm" placeholder="Resumen del contenido del acto"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            addButton.addEventListener('click', function() {
                const template = `
                    <div class="sumario-item border border-gray-200 p-4 rounded-md bg-white shadow-sm relative mt-4">
                        <button type="button" class="remove-sumario absolute top-2 right-2 p-2.5 rounded-lg shadow-sm transition-all duration-300 flex items-center justify-center gap-2 font-medium text-sm md:text-base bg-red-600 hover:bg-red-700 text-white">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Tipo de Acto <span class="text-red-500">*</span></label>
                                <select name="sumarios[${sumarioCount}][tipo_acto]" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-slate-800 focus:ring-slate-800 sm:text-sm">
                                    <option value="">Seleccione...</option>
                                    <option value="Providencia Administrativa">Providencia Administrativa</option>
                                    <option value="Resolución">Resolución</option>
                                    <option value="Acuerdo">Acuerdo</option>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Número de Acto <span class="text-red-500">*</span></label>
                                <input type="text" name="sumarios[${sumarioCount}][numero_acto]" required placeholder="Ej: 001-2026" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-slate-800 focus:ring-slate-800 sm:text-sm">
                            </div>
                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-gray-700">Descripción Corta / Asunto <span class="text-red-500">*</span></label>
                                <textarea name="sumarios[${sumarioCount}][descripcion]" required rows="2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-slate-800 focus:ring-slate-800 sm:text-sm" placeholder="Resumen del contenido del acto"></textarea>
                            </div>
                        </div>
                    </div>
                `;
